...
class DetectedObject {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.candidate_trajectoriess = null;
      ...
      if (initObj.hasOwnProperty('candidate_trajectoriess')) {
        this.candidate_trajectoriess = initObj.candidate_trajectoriess
      }
      else {
        this.candidate_trajectoriess = new LaneArray();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [candidate_trajectoriess]
    bufferOffset = LaneArray.serialize(obj.candidate_trajectoriess, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [candidate_trajectoriess]
    data.candidate_trajectoriess = LaneArray.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += LaneArray.getMessageSize(object.candidate_trajectoriess);
    return length + 249;
  }

  static datatype() {
    // Returns string type for a message object
    return 'tracking_msgs/DetectedObject';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '3bb4fe37c8503c462e32fc28f14a183e';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.candidate_trajectoriess !== undefined) {
      resolved.candidate_trajectoriess = LaneArray.Resolve(msg.candidate_trajectoriess)
    }
    else {
      resolved.candidate_trajectoriess = new LaneArray()
    }
