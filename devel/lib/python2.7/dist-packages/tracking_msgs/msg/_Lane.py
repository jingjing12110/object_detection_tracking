...
"""autogenerated by genpy from tracking_msgs/Lane.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','tracking_msgs/Waypoint[]','uint32','float32','float32','float32','bool']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tracking_msgs.msg.Waypoint()
        _x = val1
        start = end
        end += 8
