// Generated by gencpp from file tracking_msgs/DetectedObject.msg
// DO NOT EDIT!


#ifndef TRACKING_MSGS_MESSAGE_DETECTEDOBJECT_H
#define TRACKING_MSGS_MESSAGE_DETECTEDOBJECT_H
...
#include <tracking_msgs/LaneArray.h>
...
struct DetectedObject_
{
  ...
  DetectedObject_(const ContainerAllocator& _alloc)
    ...
    , pointcloud(_alloc)
    , convex_hull(_alloc)
    , candidate_trajectoriess(_alloc)
    , pose_reliable(false)
    , velocity_reliable(false)
    , acceleration_reliable(false)
    , width(0)
  ...
  _convex_hull_type convex_hull;
   ...
   typedef  ::tracking_msgs::LaneArray_<ContainerAllocator>  _candidate_trajectoriess_type;
  _candidate_trajectoriess_type candidate_trajectoriess;
  ...
  typedef boost::shared_ptr< ::tracking_msgs::DetectedObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tracking_msgs::DetectedObject_<ContainerAllocator> const> ConstPtr;

}; // struct DetectedObject_

typedef ::tracking_msgs::DetectedObject_<std::allocator<void> > DetectedObject;

typedef boost::shared_ptr< ::tracking_msgs::DetectedObject > DetectedObjectPtr;
typedef boost::shared_ptr< ::tracking_msgs::DetectedObject const> DetectedObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::tracking_msgs::DetectedObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::tracking_msgs::DetectedObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::tracking_msgs::DetectedObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tracking_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tracking_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
{
  ...
  static const char* value(const ::tracking_msgs::DetectedObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3bb4fe37c8503c46ULL;
  static const uint64_t static_value2 = 0x2e32fc28f14a183eULL;
};

template<class ContainerAllocator>
struct DataType< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.candidate_trajectoriess);
...
template<class ContainerAllocator>
struct Printer< ::tracking_msgs::DetectedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tracking_msgs::DetectedObject_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "candidate_trajectoriess: ";
    s << std::endl;
    Printer< ::tracking_msgs::LaneArray_<ContainerAllocator> >::stream(s, indent + "  ", v.candidate_trajectoriess);
...
#endif // TRACKING_MSGS_MESSAGE_DETECTEDOBJECT_H
