...
namespace piecewise_plane_fitting {
...
#define SLRPointXYZIRL piecewise_plane_fitting::PointXYZIRL
#define VPoint velodyne_pointcloud::PointXYZIR
#define RUN pcl::PointCloud<SLRPointXYZIRL>

// Register custom point struct according to PCL
POINT_CLOUD_REGISTER_POINT_STRUCT(piecewise_plane_fitting::PointXYZIRL,
...
class PlaneGroundFilter {
 private:
  ...
  // pcl::PointCloud<VPoint>::Ptr g_not_ground_pc(new
  // pcl::PointCloud<VPoint>()); pcl::PointCloud<SLRPointXYZIRL>::Ptr
  // g_all_pc(new pcl::PointCloud<SLRPointXYZIRL>());
  ...
  void post_process(const pcl::PointCloud<VPoint>::Ptr in,
