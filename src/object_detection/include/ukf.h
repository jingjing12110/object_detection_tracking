...
class UKF {
 ...
 public:
  ...
  bool is_stable_;
  tracking_msgs::DetectedObject object_;
  std::string label_;
  ...
  void updateSUKF(const std::vector<tracking_msgs::DetectedObject>& object_vec);
  ...
  double calculateNIS(const tracking_msgs::DetectedObject& in_object,
                      const int motion_ind);

  bool isLaneDirectionAvailable(const tracking_msgs::DetectedObject& in_object,
                                const int motion_ind,
